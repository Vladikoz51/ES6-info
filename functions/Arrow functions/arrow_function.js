...
// Если тело функции состоит только из одной строчки то фигурные скобки и return можно опустить , также если у функции
// только один параметр то круглые скобки тоже можно опустить.
const arrSqrt2 = num =>
    typeof num === "number" && num > 0 ? console.log(Math.sqrt(num)) : console.log("Введите положительное число");
...
//     // }
//
//     // Если метод у объекта задан при помощи стрелочной функции то при вызове метода call()
